...
('Garden Veggie', 'Bell peppers, onions, mushrooms, black olives, and fresh tomatoes.', 13.99, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80', 'veggie'),
('BBQ Chicken', 'Grilled chicken, red onions, cilantro, and tangy BBQ sauce.', 15.99, 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=800&q=80', 'specialty'),
('Truffle Mushroom', 'Wild mushrooms, truffle oil, roasted garlic, and parmesan.', 17.99, 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80', 'specialty'),
('Spicy Diavola', 'Spicy salami, chili flakes, mozzarella, and hot honey drizzle.', 16.49, 'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?auto=format&fit=crop&w=800&q=80', 'specialty');
